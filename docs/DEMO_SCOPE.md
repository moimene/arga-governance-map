...
> **Propósito:** Delimitar formalmente qué está implementado como demo funcional y qué exige la ETD para una release enterprise. Este documento es la referencia para cualquier debate de alcance con el equipo técnico o con MAPFRE.
...
1. Validar la filosofía de producto con MAPFRE antes de iniciar desarrollo real.
...
4. **Evidencias forenses** — tabla `evidence_bundles` + hash SHA-512 + QTSP stub
