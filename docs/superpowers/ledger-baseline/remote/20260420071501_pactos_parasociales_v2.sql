-- Migration 000015 (modified) — only pacto_clausulas + pacto_evaluacion_results
-- Skips CREATE TABLE pactos_parasociales (already exists with flat schema in Cloud)

-- Table: pacto_clausulas (normalized detail table)
