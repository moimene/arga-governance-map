...
-- Backfill correctivo: 10 PRESIDENTE + 1 SECRETARIO vigentes sin AE.
-- CONSEJERO_COORDINADOR removido del array (L15-L16 RRM art. 109).
...
DECLARE
  v_cargos_certificantes text[] := ARRAY[
    ...
    -- Es lider independiente del CdA (LSC 529 septies) pero la
    -- facultad de certificar es exclusiva del Secretario con VoBo
    -- del Presidente. Decision legal Garrigues 2026-05-12.
  ];
BEGIN
