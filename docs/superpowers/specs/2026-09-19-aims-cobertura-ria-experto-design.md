...
- **DS-38 Cambio significativo como consulta interna (RH-2).** «Cambios significativos en el diseño» (111.2) no es «modificación sustancial» (3.23) y el Ómnibus no lo define. La herramienta no lo deriva: la clase SIGNIFICATIVO_111_2 exige un dictamen de consulta interna (Secretaría, asunto CAMBIO_SIGNIFICATIVO_111_2) y el motivo.
