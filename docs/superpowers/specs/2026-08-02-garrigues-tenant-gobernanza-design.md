...
4. El **catálogo normativo** navega de política → comité responsable → personas, con las 32 PI reales. ✅ *Verificado en vivo en G4 (PI-30 → Comité de Gobernanza de la Inteligencia Artificial).*
