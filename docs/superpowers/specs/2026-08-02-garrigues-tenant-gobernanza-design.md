...
- **D-5 Aplicabilidad de módulos por tenant: RESUELTA (2026-08-03)** — se ocultan por tenant vía `tenants.branding.modules` filtrando sidebar/rutas (DORA, country packs aseguradores, Board Pack de cotizada fuera del perfil despacho). ARGA sin cambio (branding NULL = todo visible). Implementación en G4/G5.
