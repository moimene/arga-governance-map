...
- **…salvo EAD Trust** (European Agency of Digital Trust, S.L.; 51,001% vía Compañía Digital NewLaw, S.L.U.): **único consejo de administración colegiado** del perímetro operativo. Doble rol: entidad gobernada + QTSP del ecosistema (solo interposición, mensajería básica y custodia/e-archiving; sin QES/ERDS conforme a la política 2026-07-21). **Composición del CdA — VERIFICADA registralmente (Carril B, 2026-08-03; NIF B85626240):** presidente **Julián Ramón Inza Aldaz**; **vicepresidente Eduardo Abad Valdenebro** (rol que la fuente interna no anticipaba); consejero delegado **Eduardo Inza Blasco** (desde 03/05/2023); consejeros **Cristina Mesa Sánchez** y **Moisés Menéndez Andrés**; secretario no consejero **Roberto Delgado Gil** (desde 20/04/2023); vicesecretaria **Belén Aguayo** (apellido completo no deletreado en fuente sin login — único matiz pendiente). Nombres completos vía datoscif.es + texto oficial BOE (CVE `BORME-A-2024-239-28` con 7 apoderados citados literalmente). Domicilio Calle Méntrida 6 (distinto del grupo), capital 3.445 €, auditor Lillo Auditores. La figura de consejero delegado implica delegación de facultades inscrita → contenido real para el módulo de Delegaciones.
...
**Modelado de capital canónico (H5 — paridad con ARGA):** el motor no calcula sobre `condiciones_persona` a secas — vive en `entity_capital_profile` (una fila VIGENTE por entidad), `share_classes`, `capital_holdings` y `censo_snapshot`. Seed de la matriz: capital **vigente registral 11.104.008 €** (tras ampliación de 32.000 € inscrita el 24/04/2026, anuncio BORME 212100, I/A 952; el balance consolidado a 31/12/2025 decía 11.040 miles € — ambas cifras correctas en fechas distintas, el perfil VIGENTE usa la registral y la histórica queda datada); clase **A** de participaciones **numeradas** (los actos BORME venden participaciones concretas: 121A-122A, 163A-164A, 269A-270A, 315A-316A, 3040A-3041A — patrón ~2 por socio, coherente con ~695 participaciones estimadas); autocartera **18 participaciones = 2,59% de los derechos de voto** con `is_treasury = true` (regla canónica: voting_weight 0 y denominator_weight 0), **nutrida por compras reales a socios salientes** (BORME 2026: bajas de Sotelo, Llamas, Menéndez Vega y De Frutos; alta de Silva Castañón comprando 163A-164A de autocartera); restricción agregada real adicional: los 3 socios presenciales (Vives, Zarza, Delgado) suman **0,8875%**. Los pesos individuales por socio **no son públicos** (el Anexo 2 del acta no está transcrito): se simulan verosímiles, etiquetados `INFERIDO`, respetando las restricciones agregadas reales. **El censo es DINÁMICO:** el de la Junta (6-may) difiere del vigente (jul-2026, con las bajas/altas posteriores inscritas) — G2 fecha el `censo_snapshot` de la Junta y refleja los movimientos posteriores como histórico BORME_CITADO. `censo_snapshot` tipo UNIVERSAL de la Junta 2026 como base del caso canónico (§3.6). Filiales: la matriz como socio único/mayoritario en `capital_holdings` con los % del IDC. Vocabulario de cargos registrales para G2 (del BORME real): `Adm. Único`, `Soc.Prof.`, `Apoderado`, `Apo.Sol.`, `Auditor`, `Aud.C.Con.`; auditor real: **Lillo Auditores Asociados SL** (reelección inscrita 19/06/2026).
...
9. Centro de Estudios, evolución 2026: el punto 4 del orden del día de la Junta 2026 aprueba una **"Operación de toma de participación"** en el Centro de Estudios, posterior a la transmisión del 20% comunicada en 2025 — dirección del movimiento sin reconciliar entre fuentes; cargar señalada. Lead del Carril B: posible vehículo "Centro Europeo de Estudios y Formación Empresarial Garrigues SLP" (NIF B81011470), sin investigar.
10. **Supervisión del PPD (detectada en G4, 2026-08-16):** el Manual de Prevención de Delitos de 2018 atribuye la supervisión del programa al **Comité de Práctica Profesional**; la estructura de gobierno vigente (§3.1) añade un **Comité de Prevención de Delitos** con esa misión. Las dos fuentes son de fechas distintas y ninguna deroga expresamente a la otra. Criterio aplicado en el seed: el ownership se atribuye **según lo que dice cada documento fuente**, sin unificar en silencio — PPD-01 queda bajo Práctica Profesional (lo que dice su manual), los controles del programa bajo Prevención de Delitos (la estructura vigente). Confirmar con el despacho antes de tratar cualquiera de las dos como firme.

**Resoluciones del Carril B (2026-08-03) sobre esta lista:** la incidencia de Sports & Entertainment queda **explicada** (sociedad EXTINGUIDA desde 10/01/2018 con la matriz como Adm. Único y Liquidador — el inventario e ISO arrastraban una sociedad muerta); "EWCH" resuelta como **EWOH Inversiones 2010, S.L.** (B86021698) y "Garben" corregida a **Garmen Inversiones 2013, S.L.** (B86825437), ambas con confianza alta no absoluta (una base de datos subyacente + una fuente independiente — verificación adicional antes de CONFIRMADO); **Garrigues Portugal SLP** (B81745754) presenta socios profesionales propios en BORME (patrón de la matriz, no de filial-vehículo) → posible SLP hermana, parent retirado del catálogo; 10 NIFs confirmados; los tres vehículos (Violet/EWOH/Garmen) comparten administradora (Rino Asesores SLP = hoy Garrigues Letrados de Soporte SLP) y lote de apoderados de 12/11/2021, con titular directo del capital SIN RESOLVER (los agregadores solo señalan cabecera última).
...
- **Ciclo registral confirmado por BORME (2026-08-03):** los acuerdos de la Junta del 6-may quedaron **inscritos el 13/07/2026** (anuncio 338618, I/A 960: cese + nombramiento de Vives como Adm. Único y modificación del art. 36; anuncio 338619, I/A 961: alta del socio Silva Castañón) — el caso canónico puede mostrar el expediente completo con fechas reales de adopción → elevación → inscripción → publicación BORME en el Tramitador.
...
### Carril B — históricos BORME por sociedad (M, **ACTIVADO 2026-08-03**)

Carril de adquisición de dato público, independiente del código de producto (scripts + dataset en este repo; sin worktree nuevo). **Decisión 2026-08-03 (revierte el diferimiento):** el usuario aportó la página BORME real de la matriz y demuestra un rendimiento que la spec no anticipaba — **los socios profesionales de una SLP se inscriben en el RM** (`Soc.Prof.` como cargo registral), así que el censo y sus altas/bajas son reconstruibles de fuente oficial; el capital vigente y los apoderamientos también. G2 se beneficia directamente → se activa ya, en dos vertientes con agentes:

- **Vertiente B1 — BORME por sociedad** (agente de investigación web, background): para cada sociedad española del perímetro, dataset JSON en `scripts/garrigues/borme/<slug>.json` con actos citados (`BORME_CITADO`: anuncio nº, CVE, fecha, datos registrales S/H/IA), cargos vigentes y capital. Objetivos concretos además del histórico: **resolver la denominación real de "EWCH(?) Inversiones"** (H1 pendiente), confirmar la composición del CdA de EAD Trust, NIFs reales de filiales y titulares directos de los vehículos (Violet/EWCH/Garben). Fuentes: datos abiertos del BOE y páginas públicas sin login; lo no localizable queda `PENDIENTE`, jamás inventado.
- **Vertiente B2 — censo del acta** (agente local, background): transcripción de la lista nominal de socios asistentes de las páginas 4-8 del depósito RM (PDF en local) → `scripts/garrigues/censo/socios-acta-2026-05-06.json` (3 presenciales + 343 representados; check aritmético contra 346).
- **Ejemplo de schema ya en repo:** `scripts/garrigues/borme/jya-garrigues-slp.json`, parseado de la página aportada por el usuario (matriz, actualizada a 17/07/2026).
- La condición de diseño se mantiene: seeds aditivos/idempotentes; el dataset se inyecta sobre `data_provenance` y las tablas de dominio sin re-sembrar.
...
- **Gate de informe preceptivo del Consejo de Socios**: requisito PRE para materias reservadas cuando adopta la Junta; lista de materias = **fijada por dictamen del Comité Legal 2026-08-04** (4 materias, `firmeza:"DEMO_PILOTO"`, dos órganos informantes, solo matriz — registro `docs/legal/2026-08-04-decisiones-comite-legal-slp-garrigues.md`).
...
### G4 — Sistema normativo interno navegable (M, **EJECUTADA 2026-08-16**)
- Las **32 PI** + Código Ético + PPD + Manual PBC/FT como catálogo en `/politicas` con metadatos y **ownership real por comité**: Práctica Profesional impulsa el sistema; Editorial Global ↔ PI-14; CACI + senior partner ↔ PBC/FT; Comité IA ↔ PI-30; SII ↔ PI-31. *(La spec decía "30 PI" por conteo aproximado del inventario; el índice real de los PDF trae 32.)*
...
**Cerrada así (plan `docs/superpowers/plans/2026-08-13-g4-sistema-normativo-garrigues.md`, diseño `docs/superpowers/specs/2026-08-13-g4-sistema-normativo-garrigues-design.md`):** **39** documentos normativos (32 PI + Código Ético + Código de Conducta del Socio + PPD ×3 + Manual PBC/FT + protocolo LGTBI), 21 filas de obligaciones (**19 exigibles + 2 exclusiones etiquetadas**) con el artículo verificado contra el BOE, y 23 controles. Tres desviaciones respecto de lo previsto aquí, todas por evidencia:

- La **comunicación sistemática** al SEPBLAC, que este documento daba por obligación, **no es exigible** al despacho: el art. 27.3 RD 304/2014 exime a los sujetos obligados k)–y) y Garrigues es ñ). Corroborado además por ausencia en su propio Manual. Se carga como **exclusión etiquetada**, no como obligación pendiente. *(Cotejado en la review de cierre contra el consolidado del BOE — RD 304/2014 actualizado a 24/04/2024 y Ley 10/2010 a 21/03/2026: el artículo es idéntico y la letra ñ) sigue en el rango exceptuado. Punto del Comité Legal **cerrado**; las 21 citas quedan verificadas contra texto vigente.)*
- **El ownership acreditado es de 3 documentos, no de la tabla de §6.** Este documento anunciaba que "Práctica Profesional impulsa el sistema" y de ahí se derivó una atribución que las fuentes no sostienen: el Código Ético (art. 43.1) y el Programa de Prevención de Delitos (PPD-01 §8.1) hacen responsable al **Senior Partner** —un cargo, no un `governing_body`— y al Comité de Práctica Profesional solo lo *auxilian* o le piden *informe previo*; el Catálogo ejemplificativo no menciona comité alguno. Impulsar no es ser responsable. Esos cuatro documentos quedan con FK NULL y el cargo literal en `owner_function`, mismo criterio que ya se aplicó a PI-31. Quedan acreditados PBC-FT-10 ↔ CACI, PI-30 ↔ Comité de Gobernanza de la IA y PI-14 ↔ Editorial Global, este último **marcado como selección forzada por el modelo** (su Anexo 1 nombra cuatro comités editoriales sin jerarquía y la consola solo modela uno).
- **D-5 implementada íntegra en esta fase** (no repartida con G5): ver §5.

Además, G4 cerró tres defectos de contaminación de ARGA que existían desde antes de la fase (dato de aseguradora cableado en `/politicas` y `/obligaciones`, el artículo dentro de `source` en las 2 filas de Solvencia II de ARGA), y amplió el gate de aislamiento cross-tenant de 4 a 7 tablas — `policies`, `obligations` y `controls` no estaban cubiertas.
...
- **D-3 Informes preceptivos: RESUELTA y CONCRETADA (dictamen Comité Legal 2026-08-04)** — versión demo operativa: 4 materias (admisión socio de cuota, exclusión estatutaria, continuidad post-60 → Consejo de Socios; nombramiento de administrador único → Comité de Nominaciones), `fuente:"ESTATUTOS_ART_21_1"` + `firmeza:"DEMO_PILOTO"`, gate BLOCKING pre-convocatoria limitado a la matriz, con 5ª plantilla de informe para que el bloqueo tenga salida. Citas Ley 2/2007 del overlay firmes a nivel de artículo (13/14/15+16/4/8); la antelación cita solo LSC supletoria. Registro: `docs/legal/2026-08-04-decisiones-comite-legal-slp-garrigues.md`.
...
- **D-5 Aplicabilidad de módulos por tenant: RESUELTA (2026-08-03) e IMPLEMENTADA ÍNTEGRA EN G4 (2026-08-16)** — se ocultan por tenant vía `tenants.branding.modules` filtrando sidebar/rutas (DORA, country packs aseguradores, Board Pack de cotizada fuera del perfil despacho). ARGA sin cambio (branding NULL = todo visible). El mecanismo **falla abierto** a propósito: `isModuleEnabled` devuelve `true` con branding nulo o con una lista malformada, así que un tenant sin configurar nunca pierde módulos. No se repartió con G5: al ser un filtro de navegación, dejarlo a medias habría dejado enlaces vivos a módulos ocultos.
...
4. El **catálogo normativo** navega de política → comité responsable → personas, con las 32 PI reales. ✅ *Cumplido en G4, pero solo tras la review adversarial de cierre.* La primera verificación **fue falsa**: se leyó en pantalla "Propietario: Comité de Gobernanza de la Inteligencia Artificial" y se dio por probada la arista, cuando ese rótulo salía de `owner_function` —texto libre— y coincidía porque el seed escribe la FK y el texto con el mismo valor. `owner_body_id` era dato **write-only**: ninguna superficie lo leía. Hoy la cadena existe de verdad (ficha → comité enlazado por slug → ficha de cada miembro) y está anclada por un test con mutación probada. **Lección de método: verificar un rótulo no prueba una relación.**
