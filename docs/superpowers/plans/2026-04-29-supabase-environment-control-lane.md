...
| Tipos generados | Verde congelado | Incluyen objetos criticos, pero no se regeneran sin migracion aprobada. |
...
2. No aplicar migraciones ni cambios RLS/RPC/storage desde carriles funcionales.
...
| Regenerar tipos | Solo despues de migracion aprobada y aplicada. |
