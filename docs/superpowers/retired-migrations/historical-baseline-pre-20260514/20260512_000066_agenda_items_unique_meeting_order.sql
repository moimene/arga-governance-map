-- Migration: 20260512_000066_agenda_items_unique_meeting_order
--
...
-- el más antiguo (ROW_NUMBER por created_at ASC).
--
-- useMaterializeAgendaItem (TS) ahora cachea UNIQUE violation (23505) y
-- hace fallback SELECT del existing row para mantener idempotencia
-- client-side.
...
BEGIN
  WITH ranked AS (
    SELECT id,
           ROW_NUMBER() OVER (
             PARTITION BY meeting_id, order_number
...
-- ============================================================================
-- END 20260512_000066_agenda_items_unique_meeting_order
-- ============================================================================
