...
describe("el universo del mapa está cerrado contra el catálogo", () => {
  ...
  it("cada fila se fija contra el ARTÍCULO del requisito en el catálogo, no contra el propio mapa", () => {
    ...
    const POR_ARTICULO: Record<string, string> = {
      ...
      // Numeración del anexo A de ISO/IEC 42001:2023 tras el recotejo (F1.T13).
      "ISO 42001 A.2": "iso-42001-management-system",
      "ISO 42001 A.3": "governance-accountability",
      "ISO 42001 A.4": "iso-42001-management-system",
      "ISO 42001 A.5": "fundamental-rights-dpia",
      "ISO 42001 A.6": "iso-42001-management-system",
      "ISO 42001 A.7": "data-governance",
      "ISO 42001 A.8": "transparency-user-information",
      "ISO 42001 A.9": "governance-accountability",
      "ISO 42001 A.10": "provider-vendor-third-party",
      "ISO 42001 6.1": "iso-42001-management-system",
