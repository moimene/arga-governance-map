...
export const platformReadinessLanes: PlatformReadinessLane[] = [
  ...
  },
  {
    ...
    summary: "Inventario, clasificación guiada, evaluaciones e incidentes con escritura propia; alta de sistemas sólo por cuestionario; sin firma ni custodia cualificada.",
    nextAction: "Clasificar cada sistema desde su ficha y reevaluar contra su catálogo.",
    migrationRequired: false,
    finalEvidence: false,
  },
  {
