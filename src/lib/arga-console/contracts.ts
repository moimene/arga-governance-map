...
export const consoleDataContracts: ConsoleDataContract[] = [
  ...
  },
  {
    ...
    evidence: "verifiable",
    sourcePosture: "Cloud",
    parityRisk: "Verificable solo si bundle, hash, storage y audit chain están completos.",
  },
  {
...
export const consoleJourneys: ConsoleJourney[] = [
  {
    ...
    targetRoute: "/grc/incidentes",
    mutationHandoff: "GRC emite evento/link; Secretaría crea expediente si procede.",
  ...
  },
  {
    ...
    contract: "governance_module_events + governance_module_links",
    targetRoute: "/ai-governance/evaluaciones",
    mutationHandoff: "AIMS emite evento/link; GRC crea control o plan owner.",
    evidencePosture: "pending",
  },
  {
    id: "secretaria-certification-evidence",
    title: "Certificación Secretaría como evidencia",
    summary: "Un acta o certificación emitida alimenta controles GRC/AIMS por evidence_id.",
    sourceOwner: "Secretaría",
    targetOwner: "Backbone evidencia",
    sourceTable: "certifications",
    contract: "evidence_bundles + audit_log",
    targetRoute: "/secretaria/actas",
    mutationHandoff: "Secretaría/QTSP emite; consumidores referencian evidence_id.",
    evidencePosture: "verifiable",
  },
  {
