    ...
    <section className="grid grid-cols-1 gap-4 lg:grid-cols-12">
      ...
      <Card className="overflow-hidden lg:col-span-4">
        <button
          ...
          className="flex w-full items-center gap-2 border-b border-border px-5 py-4 text-left hover:bg-accent/40"
        >
          <Link2 className="h-4 w-4 text-primary" />
          <h2 className="text-sm font-semibold text-foreground">Contratos de datos</h2>
          <span className="ml-auto text-[11px] text-muted-foreground">
            {contractsOpen ? "Ocultar" : `Ver ${visibleContracts.length}`}
          </span>
        </button>
        {contractsOpen && (
          <div className="divide-y divide-border">
