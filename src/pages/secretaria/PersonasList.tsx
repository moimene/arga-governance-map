  ...
  return (
    <div className="mx-auto max-w-[1440px] p-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--g-text-secondary)]">
            {isSociedadMode
              ...
              : "Personas físicas (PF) y jurídicas (PJ) del modelo canónico: socios, administradores, miembros de órganos, representantes."}
          </p>
        </div>
        <Link
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2">
        ...
        {isSociedadMode ? (
          <div
            className="flex flex-wrap items-center gap-2 border border-[var(--g-border-subtle)] bg-[var(--g-surface-card)] px-3 py-2 text-xs text-[var(--g-text-secondary)]"
            style={{ borderRadius: "var(--g-radius-md)" }}
          >
            <span className="font-medium">Sociedad</span>
            <span className="font-semibold text-[var(--g-text-primary)]">{selectedEntityName}</span>
