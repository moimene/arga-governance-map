...
const AGREEMENT_KINDS: Record<string, string[]> = {
  ...
  ORDINARIA:   [
    ...
    "APROBACION_PRESUPUESTOS", "FINANCIACION", "CONTRATACION_RELEVANTE",
...
const AGREEMENT_KIND_LABELS: Record<string, string> = {
  ...
  APROBACION_PRESUPUESTOS:"Aprobación del Presupuesto Anual",
  FINANCIACION:          "Aprobación de financiación",
  CONTRATACION_RELEVANTE:"Contratación relevante",
