...
const glosario = [
  ...
  { term: "Control", def: "Mecanismo que mitiga una obligación.", example: { label: "CTR-001", to: "/obligaciones" } },
  { term: "Delegación", def: "Poder conferido a una persona con límites y vigencia.", example: { label: "D. Carlos Vaz", to: "/delegaciones" } },
  { term: "Entidad", def: "Persona jurídica del grupo.", example: { label: "ARGA Brasil", to: "/entidades/arga-brasil" } },
  { term: "Evidencia", def: "Prueba documentada de la ejecución de un control.", example: { label: "Adjuntas a controles", to: "/obligaciones" } },
  ...
  { term: "Hallazgo", def: "Observación de auditoría o cumplimiento.", example: { label: "HALL-008", to: "/hallazgos" } },
  { term: "Mandato", def: "Período de cargo de un miembro de un órgano.", example: { label: "Composición", to: "/organos" } },
  { term: "Materialidad", def: "Clasificación de importancia de una entidad.", example: { label: "Ver entidades", to: "/entidades" } },
  { term: "Obligación", def: "Requisito normativo interno o externo.", example: { label: "OBL-DORA-003", to: "/obligaciones" } },
  { term: "Órgano", def: "Consejo, comisión u órgano de gobierno.", example: { label: "Consejo", to: "/organos" } },
  { term: "Política", def: "Norma interna del grupo.", example: { label: "PR-008", to: "/politicas" } },
