...
const CONFIG_CONDICIONAL: CatalogEntry[] = [
  ...
  { key: "sector_regulado", value_type: "enum", allowed_values: ["BANCA", "SEGUROS", "ENERGIA", "FARMA", "COTIZADAS", "EIP", "INMOBILIARIO", "PUBLICO_PRIVADO", "MERCADO_VALORES", "GENERICO"], default_value: "GENERICO", descripcion: "Sector regulatorio principal de la sociedad. Activa sugerencia de bloques sectoriales. Debe coincidir con el enum de bloques_sectoriales.sector (migration T4).", categoria: "CONFIG_CONDICIONAL" },
