-- ============================================================================
-- Migration: 20260511_000058_v2_plantillas_overrides.sql
...
--
-- Triggers created:
--   tr_validate_catalog_consistency           — enum requires allowed_values; default ∈ allowed_values
--   tr_validate_entity_setting_value          — value vs catalog.value_type
--   tr_validate_capa3_override                — opciones+default+campo+estado
--   tr_bloques_immutable_when_active          — texto_aprobado WORM en ACTIVA
--   tr_bloques_no_delete                      — soft-delete only
--   tr_worm_bloque_insertions_update          — append-only (UPDATE)
--   tr_worm_bloque_insertions_delete          — append-only (DELETE)
--   tr_worm_plantilla_changelog_update        — append-only (UPDATE)
--   tr_worm_plantilla_changelog_delete        — append-only (DELETE)
-- ============================================================================
...
-- WORM triggers — reusar worm_guard() existente en 20260419_000001_rule_engine_tables.sql
...
-- ============================================================================
-- END migration 20260511_000058_v2_plantillas_overrides
-- ============================================================================
