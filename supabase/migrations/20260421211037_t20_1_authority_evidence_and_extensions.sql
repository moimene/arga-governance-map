-- F1.2 + F1.3 — authority_evidence + extensions minutes/certifications
-- Corrige: tipo_condicion (no role) + estado='VIGENTE'
...
-- Opcional CHECK sobre fuente_designacion (permite NULL para datos legacy)
ALTER TABLE condiciones_persona
...
-- Sincroniza authority_evidence desde condiciones_persona
-- solo para cargos que certifican.
-- ============================================================
...
BEGIN
  -- Solo actuar si el cargo es certificante
  ...
  ELSIF TG_OP = 'UPDATE' AND NEW.tipo_condicion = ANY (v_cargos_certificantes) THEN
    -- Si cesó: cerrar authority_evidence correspondiente
...
-- ============================================================
-- F1.2e — Backfill inicial desde condiciones_persona VIGENTES
-- Nota: SECRETARIO actualmente NO está en body_admin solo (está con body_id),
-- y todos los datos demo están como BOOTSTRAP porque eran del seed original.
-- ============================================================
INSERT INTO authority_evidence (
  tenant_id, entity_id, body_id, person_id, cargo,
...
-- ============================================================
-- F1.3a — Extend minutes con snapshot_id, content_hash, rules_applied, body_id, entity_id
-- ============================================================
ALTER TABLE minutes
...
-- ============================================================
-- F1.3b — Extend certifications con tipo + authority + hash chain + TSQ
-- ============================================================
