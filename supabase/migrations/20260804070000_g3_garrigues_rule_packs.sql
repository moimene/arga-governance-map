...
--   - Granularidad: toda "referencia" visible cita el artículo únicamente
--     ("art. 13 Ley 2/2007"). Los apartados (4.2/4.3) solo aparecen dentro
--     de una "redaccion" porque son texto VERBATIM aprobado por el Comité
--     para ese parámetro concreto — no una cita nueva fabricada aquí.
