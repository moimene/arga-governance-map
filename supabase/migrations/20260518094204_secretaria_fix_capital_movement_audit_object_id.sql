-- Fix regression from 20260516120005_f2_g14_definer_hardening.sql:
-- audit_log.object_id is uuid, but the hardened function wrote p_agreement_id::text.
-- Transmission flows with p_agreement_id = null failed before creating capital_movements.
...
COMMENT ON FUNCTION public.fn_registrar_movimiento_capital(uuid, uuid, uuid, uuid, uuid, numeric, numeric, numeric, text, date, text) IS
  '20260518: fixes audit_log.object_id uuid regression while preserving F2.G14 tenant guard and search_path hardening.';
